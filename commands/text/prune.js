...
module.exports = {
	...
	run: async msg => {
		if (!msg.guild.me.hasPermission('KICK_MEMBERS')) return msg.channel.send("I can't kick members from this guild")
		if (!msg.member.hasPermission('ADMINISTRATOR') && msg.author.id != botOwnerID) return msg.reply("You don't have permission to use this command")
